-- ============================================================================
-- SCRIPT CỦA ANTIGRAVITY: CHUẨN HÓA BẢNG LIÊN KẾT GIAO BÀI TẬP & RLS POLICIES
-- ĐẢM BẢO QUY TRÌNH XUẤT BẢN VÀ GIAO BÀI TẬP HỌC THUẬT AN TOÀN TUYỆT ĐỐI
-- ============================================================================

BEGIN;

-- 1. BẢNG LIÊN KẾT PUBLIC.ACADEMIC_EXERCISE_ASSIGNMENTS
...
-- 3. BẬT RLS VÀ CÀI ĐẶT POLICY TRÊN ACADEMIC_EXERCISE_ASSIGNMENTS
...
-- SELECT POLICY:
-- Admin: xem tất cả.
-- Teacher: xem các bài giao cho lớp do mình phụ trách hoặc bài mình tạo.
-- Student: xem các bài giao cho lớp mình gia nhập trong class_members.
...
-- 4. CẬP NHẬT RLS POLICY TRÊN BẢNG BÀI TẬP PUBLIC.ACADEMIC_EXERCISES
...
-- 5. CẬP NHẬT RLS POLICY TRÊN BẢNG CÂU HỎI PUBLIC.ACADEMIC_EXERCISE_QUESTIONS
...
-- 6. RPC SECURITY DEFINER: GIAO BÀI TẬP CHO NHIỀU LỚP ATOMIC
