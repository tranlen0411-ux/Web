              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-3 pr-12 bg-amber-50 border-2 border-amber-200 rounded-2xl font-bold text-sm text-slate-800 focus:outline-none focus:border-amber-400"
                    required
                  />
                  <button
                    type="button"
